...
class TenFCVDataset:
    ...
    def get_eval_data(self):
        return self._subject_dataset, self._subject_label, self._test_idx
...
class ArgCenter:
    ...
    def lee(self):
        ...
        parser.add_argument('--seq_len_hlt', default=65, type=int)
        parser.add_argument('--sliding_window', default=10, type=int)
        parser.add_argument('--patch_len', default=1, type=int)
        parser.add_argument('--dropout', default=0.2, type=float)
        parser.add_argument('--device', default=torch.device("cuda:0" if torch.cuda.is_available() else "cpu"),
                            type=str)
        ...
        parser.add_argument('--num_token', default=65, type=int)
        ...
        parser.add_argument('--how_train', default='fixed', type=str)
